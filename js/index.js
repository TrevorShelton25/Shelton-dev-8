...
BC, updatecount() was not being called on line 51-TS
#################################################*/
...
BC, I would create an if statement that would search to see if there is already a
item in the list, if there is a similar item in the list, the if statement should return
a blank space to keep the customer from seeing two of the same item.-TS
#################################################*/		
